  ...
  return (
    <div className="main grid">
      <div className="main-uno row">
        <div
          className="carousel-slide col-7"
        ...
        <div className="header-sub col-4">KABOOM</div>
      </div>
      <div className="main-dos row">
        <div className="main-sub1 col-6">
          <h2>Nationwide Container Home Provider</h2>
          <p>
            Durable & Low Cost Prefab Modular Building. Uses Light Steel
            Structure Building. Fully Customizable & Resilient Against Typhoons,
            Strong Winds and Earthquakes. Durable. Architecturally-Designed. Low
            Cost. High Quality.
          </p>
          <p>
            Owning a property is one of the main goals of every Filipino. But
            considering the costs and efforts to get there can prove difficult
            for families. While landed properties are more common, people are
            now also looking at cost-effective solutions for their dreams homes.
            One such options is the prefabricated container houses. You maybe
            shaking your heads in disapproval, but it has been a growing trend
            for years now.
          </p>
          <p>
            Are containers insulated? Sea containers are generally constructed
            out of lightweight materials that consist mostly of
            corrosion-resistant steel coated with a protective varnish, lacquer
            and epoxy resin base. That's why if you're planning on converting
            one into a home, you need to coat it with insulation to ensure that
            the rooms retain a comfortable temperature. Whether going in your
            backyard or on the side of a mountain, all Backcountry Container
            designs are built to maximize their small footprint and help connect
            you to the outdoors. With large workshops in both Texas and
            Wisconsin, we can deliver our container creations anywhere in the
            country.
          </p>
        </div>
